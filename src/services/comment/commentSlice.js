...
// Fetch Most Like Comments
export const getMostLikedCommentsByPostId = createAsyncThunk(
  "comment/getMostLiked",
  async (postId, thunkAPI) => {
    try {
      return await commentService.getMostLikedComments(postId);
    } catch (err) {
      const message =
